...
export class FormatProvider {
    ...
    provideDocumentFormattingEdits(document: vscode.TextDocument): vscode.TextEdit[] {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (ruleMatch) {
                ...
                // 格式化规则定义
                const formattedRule = this.formatRuleDefinition(ruleName, operator, definition);
     ...
     * 格式化规则定义
     */
    private formatRuleDefinition(ruleName: string, operator: string, definition: string): string {
